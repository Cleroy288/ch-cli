...
- [UI Layout & Architecture](./layout.md) - How the UI is structured and organized
...
All UI components are implemented in the `src/ui/` module with clean separation of concerns.
